<header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-lg"><b>SOTL</b></span>
    </a>
   ...
   <div class="modal fade" id="modal-default">
                    ...
                    {{ csrf_field() }}
                      <div class="box-body">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="name" name="name" required value="{{Auth::user()->name}}" placeholder="Enter Name">
                        </div>
                        <div class="form-group">
                          <label for="email">Email address</label>
                          <input type="text" class="form-control" required value="{{Auth::user()->email}}" id="email" name="email" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" name="password_confirmation" required class="form-control" id="confirmPassword" placeholder="Confirm Password">
                        </div>
                      </div>
                      <!-- /.box-body -->
                      <div class="box-footer">
                        <button type="submit" id="profileUpdate" class="btn btn-primary">Update</button>
                      </div>
                    </form>
                  </div>
                </div>
        ...
        <script type="text/javascript">
          jQuery(document).ready( function(){
            jQuery("#profileUpdate123").click( function(){
